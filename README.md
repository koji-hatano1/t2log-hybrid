...
t2log-hybrid extends the t2log-strip approach by incorporating T1w-derived information in spatially constrained regions, enabling more stable boundary definition under challenging conditions.
